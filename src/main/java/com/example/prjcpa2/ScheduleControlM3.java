...
public class ScheduleControlM3 {
    ...
    private static String movieTitle = MoviePageController.movie3Title;
    private static Image movieImage = MoviePageController.movie3Image;
    private static String movieRating = MoviePageController.movie3Rate;
