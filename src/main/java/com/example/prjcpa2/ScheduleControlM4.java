...
public class ScheduleControlM4 {
    ...
    private static String movieTitle = MoviePageController.movie4Title;
    private static Image movieImage = MoviePageController.movie4Image;
    private static String movieRating = MoviePageController.movie4Rate;
